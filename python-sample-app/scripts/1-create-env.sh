...
print_summary() {
    log "SUCCESS" "\n========================================="
    log "SUCCESS" "Python Environment setup completed successfully!"
    log "SUCCESS" "========================================="
    ...
    log "INFO" "    * /python-sample-app/mysql/pool-size: 10"
    log "INFO" "    * /python-sample-app/mysql/max-overflow: 20"
    log "INFO" "  - IAM Policy: ${PYTHON_ORDER_API_POLICY_NAME}"
    log "INFO" "  - IAM Policy: ${PYTHON_DELIVERY_API_POLICY_NAME} (with SSM permissions)"
    log "INFO" "  - Python Order Service Account: ${PYTHON_ORDER_SERVICE_ACCOUNT_NAME}"
    log "INFO" "  - Python Delivery Service Account: ${PYTHON_DELIVERY_SERVICE_ACCOUNT_NAME}"
