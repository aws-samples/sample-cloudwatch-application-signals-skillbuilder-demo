...
setup_cloudwatch_service_account() {
    log INFO "Setting up CloudWatch service account for Python applications..."
...
setup_cloudwatch_addon() {
    log INFO "Setting up Amazon CloudWatch Observability EKS add-on for Python services..."
...
main() {
    log INFO "Starting CloudWatch setup for Python applications"
    read_cluster_config
    verify_cluster_context
    setup_service_linked_role
    start_application_signals
    ...
    log SUCCESS "\n=============================================================="
    log SUCCESS "Amazon CloudWatch Observability EKS add-on monitoring enabled!"
    log SUCCESS "================================================================"
    log INFO "\nApplication Signals and Container Insights are now active"
    log INFO "\nNext step: Run ./scripts/4-annotate-workloads.sh"
}
